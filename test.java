...
public class test {
	public static void selectMenuItem(int itemNumber) {
		switch (itemNumber) {
			case 1:
				System.out.println("You selected: Spaghetti Bolognese");
			...
			case 2:
				...
				break;
			case 3:
				System.out.println("You selected: Caesar Salad");
				System.out.println("Price: $8.49");
				break;
			case 4:
				System.out.println("You selected: Grilled Chicken Sandwich");
				System.out.println("Price: $10.99");
				break;
			case 5:
				System.out.println("You selected: Chocolate Brownie Sundae");
